...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background: url('<?php echo URL_ASSETS;?>front/images/2.jpg')no-repeat 0px 0px; background-size: cover; position: fixed; left: 0; width: 100%; height: 100%;">
								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											...
											<form action="<?php echo base_url();?>Travelitacon/savedata" method="post">
												...
												<div class="row form-group">
													<div class="col-md-12">
														<select name="level" id="level" class="form-control" required>
															<option class="hidden">Level</option>
