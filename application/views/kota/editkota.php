...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <a class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>travelitacon/edittrans/<?php echo $row['id_kota']; ?>"><i class="fa fa-pencil"></i></a>
      ...
      <form action="<?php echo base_url();?>travelitacon/saveeditkota" method="post">
            <div class="box-body">
              <div class="box-header"><center><h4>Edit Kota</h4></center></div>
              <div class="form-group">
                <label>Nama Kota</label>
                <div class="input-group">
                <input type="hidden" id="id_kota" class="form-control" value="<?php echo $id_kota ?>" name="id_kota" required>
                <input type="text" id="kota" class="form-control" value="<?php echo $kota ?>" name="kota" required>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                <input type="text" id="bandara" class="form-control" value="<?php echo $bandara ?>" name="bandara" required>
