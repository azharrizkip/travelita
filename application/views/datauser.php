...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>T</b>rip</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Trip</b>Travelita</span>
    </a>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      ...
                      <h4>
                        Travelita Team
                        <small><i class="fa fa-clock-o"></i> 30 mins</small>
                      </h4>
                      <!-- The message -->
                      <p>Selamat Bergabung di Trip Travelita!</p>
                    </a>
                  </li>
                  <!-- end message -->
                </ul>
     ...
     <div class="col-xs-12">
       <div class="box">
            <div class="box-header">
              <a href="<?php echo base_url();?>travelitacon/tambahrute" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah User</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <a onclick="return confirm('Hapus data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>travelitacon/hapususer/<?php echo $row['id_user'];?>"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                <?php } ?>
                </tbody>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:;">
              <i class="menu-icon fa fa-plane bg-green"></i>
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Pesawat tujuan Bandung</h4>
                <p>Akan berangkat pukul 09.00 WIB</p>
              </div>
            </a>
          </li>
          <li>
            <a href="javascript:;">
              <i class="menu-icon fa fa-plane bg-green"></i>
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Pesawat tujuan Bali</h4>
                <p>Akan berangkat dalam 30 menit</p>
              </div>
            </a>
          </li>
          <li>
            <a href="javascript:;">
              <i class="menu-icon fa fa-plane bg-red"></i>
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Pesawat tujuan Surabaya</h4>
                <p>Telah Berangkat 30 menit yang lalu</p>
              </div>
            </a>
          </li>
        </ul>
