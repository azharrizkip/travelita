...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-plus"></i> Tambah Transportasi
      </h1>
    </section>
    ...
    <div class="col-md-6">
     <div class="box box-success">
      <form action="<?php echo base_url()?>travelitacon/saveEdittrans" method="post">
            <div class="box-body">
              <div class="form-group">
                <label>Kode</label>
                <div class="input-group">
                <input type="hidden" id="transportationid" class="form-control" value="<?php echo $transportationid; ?>" name="transportationid" required>
                <input type="text" id="code" class="form-control" value="<?php echo $code; ?>" name="code" required>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                <input type="text" id="description" class="form-control" value="<?php echo $description; ?>" name="description" required>
                  <div class="input-group-addon">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                <input type="number" id="seat_qty" class="form-control" value="<?php echo $seat_qty; ?>" name="seat_qty" required>
                    <div class="input-group-addon">
              ...
              <div class="form-group">
                ...
                <a href="<?php echo base_url();?>travelitacon/trans" class="btn btn-primary">Kembali</a>
              </div>
            </form>
            </div>
            <!-- /.box-body -->
