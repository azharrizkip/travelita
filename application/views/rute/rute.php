     ...
     <div class="col-xs-12">
       <div class="box">
            <div class="box-header">
              <a href="<?php echo base_url();?>travelitacon/tambahrute" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Rute</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <a class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>travelitacon/editrute/<?php echo $row['id_rute']; ?>"><i class="fa fa-pencil"></i></a>
                      <a onclick="return confirm('Hapus data??');" class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>travelitacon/hapusrute/<?php echo $row['id_rute'];?>"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                <?php } ?>
                </tbody>
