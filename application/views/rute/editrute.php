...
<?php $this->load->view('inc/head2'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-pencil"></i> Edit Rute
        <small>Preview</small>
      </h1>
    </section>
    ...
    <div class="col-lg-6 col-xs-12">
      ...
      <form action="<?php echo base_url();?>travelitacon/saveEdit" method="post">
            <div class="box-body">
               <div class="bootstrap-timepicker">
                <div class="form-group">
                  <label>Waktu Keberangkatan :</label>
                  <div class="input-group">
                    <input type="hidden" value="<?php echo $id_rute;?>" id="id_rute" name="id_rute" required>
                    <input type="text" class="form-control timepicker" value="<?php echo $depart_at;?>" id="depart_at" name="depart_at" required>
                ...
                <div class="input-group date">
                  ...
                  <input type="text" value="<?php echo $depart_date;?>" name="depart_date" class="form-control pull-right" id="datepicker" required>
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <select class="form-control select2" name="rute_form">
                  <option value="<?php echo $rute_form; ?>"><?php echo $rute_form; ?></option>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                 <select class="form-control select2" name="rute_to">
                  <option value="<?php echo $rute_to; ?>"><?php echo $rute_to; ?></option>
                  <?php $no=0; foreach($data_kota as $row) { $no++ ?>
                  <option><?php echo $row['kota']?> (<?php echo $row['bandara']?>)</option>
                  <?php } ?>
                </select>
              ...
              <div class="form-group">
                <label>Harga</label>
                <div class="input-group">
                <input type="number" id="price" class="form-control" value="<?php echo $price;?>" name="price" required>
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" name="transportationid">
                  <option value="<?php echo $transportationid; ?>"><?php echo $transportationid; ?></option>
