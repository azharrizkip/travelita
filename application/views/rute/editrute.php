      ...
      <form action="<?php echo base_url();?>travelitacon/saveEdit" method="post">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input name="id_rute" value="<?php echo $id_rute; ?>" type="hidden" class="form-control" id="id_rute">
                <input type="text" id="rute_form" class="form-control" value="<?php echo $rute_form;?>" name="rute_form" required>
              </div>
              <div class="form-group">
                <label>Tujuan</label>
              ...
              <div class="form-group">
                ...
                <input type="text" id="transportationid" class="form-control" value="<?php echo $transportationid;?>" name="transportationid" required>
              </div>
              <div class="form-group">
