...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-pencil"></i> Edit Data User
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="col-md-6">
     <div class="box box-success">
      <form action="<?php echo base_url()?>travelitacon/saveedituser" method="post">
            <div class="box-body">
              <div class="form-group">
                <label>Username</label>
                <div class="input-group">
                <input name="id_user" value="<?php echo $id_user; ?>" type="hidden" class="form-control" id="id_user">
              ...
              <div class="form-group">
                <label>Level</label>
                <input type="text" id="level" class="form-control" value="<?php echo $level;?>" name="level" required>
              </div>
              <div class="form-group">
