     ...
     <div class="col-xs-12">
       <div class="box">
            <div class="box-header">
              <a href="<?php echo base_url();?>travelitacon/tambahuser" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah User</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <a class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>travelitacon/edituser/<?php echo $row['id_user']; ?>"><i class="fa fa-pencil"></i></a>
